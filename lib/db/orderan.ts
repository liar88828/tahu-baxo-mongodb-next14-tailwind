...
//       const one = await tx.orderanDB.create( {
...
//     return prisma.orderanDB.findUnique( {
//       where: { id }, include: {
//         semuaProduct: {
//           select: {
//             id       : true,
...
//     }
//
//     return prisma.orderanDB.findMany( option )
//
//   }
//
//   async getDataForOrderan() {
//     const travel                             = prisma.deliveryDB.findMany( { select: { nama: true } } )
//     const bank                               = prisma.bankDB.findMany( { select: { nama: true } } )
//     const product                            = prisma.productDB.findMany( {
//       select: {
//         id    : true,
//         nama  : true,
//         img   : true,
...
//
//       const updateData = await tx.orderanDB.update( {
//         where: { id },
//         data : this.setOne( data )
//       } );
//
