...
export type TrolleyUpdatePrisma = Omit<TrolleyDB, "transactionId" | 'isBuy'>
export type TrolleyCreatePrisma = Omit<TrolleyDB, "transactionId" | "id" | 'isBuy'>
//
...
//
export type TrolleyResponse = {
	data: Omit<TrolleyDB, "transactionId">
	status: string
}
